...
MURKA_REPLIES = {
    ...
    "работает": ["Ураа!"],
    "мурка привет":["Ты вернулся 🥹 хвостиком машу от счастья 💫","Привет, мой хозяин!🐕"],
    "мурка я люблю тебя":["И я тебя люблю! ❤️","Обниму лапками🤗"],
    "мурка скучаю":["Скучаю 😢 хвостик вниз опустился…"],
    ...
    "ногти стричь": ["Нет нет нет... Только не это", "😰 Я пожалуй пойду"], 
     # ← ВАЖНО: добавлена запятая здесь
    "бот": ["Кто звал? 🤖", "Я тут, я слежу 👀", "Гав гав", "Бот в деле, базар фильтруй 💪"],
    "спокойной ночи":["Сладких снов, хозяин, я уже пушисто укутался!🐶✨","Спокойной ночи, буду охранять твой сон пушистым носиком!"],
