...
MURKA_REPLIES = {
    ...
    "мурка какая твоя любимая песня": ["Aerosmith - What It Takes! ууу🐺💃", "Я пою громко: ГАВ-ГАВ-ГАВ 🎶","audio"],
    ...
    "мурка спой песню": ["Гав-гав-гав-гав 🎶", "Аууууу 🐺🎵","audio"],
    "мурка пой": ["ГАВ-ГАВ-ГАВ! Это моя песня 🎤🐶","audio"],
    ...
    "мурка что делаешь": ["video_note"]  # 🆕 новая команда
}
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for key, answers in MURKA_REPLIES.items():
        if key in text:
            ...
            elif "video_note" in answers:   # 🆕 проверка на видео
                try:
